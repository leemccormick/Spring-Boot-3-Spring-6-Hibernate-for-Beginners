...
public class MyDemoLoggingAspect {
    ...
    // @Around --> getFortuneRethrow
    // Add a new advice for @Around  on the getFortune method
    @Around("execution(* com.leemccormick.aopdemo.service.*.getFortuneRethrow(..))")
    public Object aroundGetFortuneRethrow(ProceedingJoinPoint theProceedingJoinPoint) throws Throwable {
        ...
        // Let's execute the method with handel exception
        Object result = null;
        try {
    ...
    // @Around
    // Add a new advice for @Around  on the getFortune method
    @Around("execution(* com.leemccormick.aopdemo.service.*.getFortune(..))")
    ...
    @After("execution(* com.leemccormick.aopdemo.dao.AccountDAO.findAccounts(..))")
