...
import com.leemccormick.aopdemo.service.TrafficFortuneService;
...
public class AopdemoApplication {
    ...
    public CommandLineRunner commandLineRunner(
        ...
        return runner -> {
            ...
            demoTheAroundAdviceHandleExceptionRethrow(theTrafficFortuneService);
        };
    }

    private void demoTheAroundAdviceHandleExceptionRethrow(TrafficFortuneService theTrafficFortuneService) {
        System.out.println("\n\n Main Program : demoTheAroundAdviceHandleExceptionRethrow()");

        System.out.println("------- Calling getFortuneRethrow -------");
        boolean tripWire = true;
        String theFortune = theTrafficFortuneService.getFortuneRethrow(tripWire);

        System.out.println("DONE : theFortune is : " + theFortune);
        System.out.println("\n");
    }
    ...
    private void demoTheAroundAdviceHandleException(TrafficFortuneService theTrafficFortuneService) {
        ...
        boolean tripWire = true;
        String theFortune = theTrafficFortuneService.getFortune(tripWire);
    ...
    private void demoTheAroundAdvice(TrafficFortuneService theTrafficFortuneService) {
        ...
        System.out.println("------- Calling getFortune -------");
        String theFortune = theTrafficFortuneService.getFortune();
