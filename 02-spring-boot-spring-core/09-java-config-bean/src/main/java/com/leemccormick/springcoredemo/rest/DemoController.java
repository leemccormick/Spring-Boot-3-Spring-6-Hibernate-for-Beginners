...
public class DemoController {
    ...
    */
    ...
    // See more example in CricketCoach how to use lifecycle methods
    ...
    */
    ...
    // Java Config Bean
    /*
    - See more example in SwimCoach
    - See more how to in SportConfig
    - On SportConfig if we give the bean id, we have to use it in @Qualifier("swimCoach")
    - In case of bean with no id, we are using this line of code --> public DemoController(@Qualifier("swimCoach") Coach theCoach) {}
    */
    @Autowired
